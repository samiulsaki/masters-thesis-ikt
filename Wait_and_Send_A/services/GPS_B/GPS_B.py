    ...
    if report['class'] == 'TPV':
        if hasattr(report, 'time'):
            ...
            try:
                ...
                with open('/home/pi/Desktop/Wait_and_Send_A/services/GPS_B/packets_recv_frm_BtoA.csv','w') as f:
                ...
                if packet_type_recv == packet_type[2]:
                    ...
                    if ack_recv == '111':
                        ...
                        with open('/home/pi/Desktop/Wait_and_Send_A/services/GPS_B/packets_sent_frm_AforB.csv','w') as f:
                                writer = csv.writer(f,delimiter='\t');
                        ...
                        t.sleep(1)
                        input = str(packet_type[6]+src_addr+dst_addr+real_dst_addr+seq_num+payload+crc)
                        ser.write(input)
                        i = i+1
                        pass
                    pass
                    ...
                    if seq_num_recv in seq_num_array:
                        ...
                        input = str(packet_type[6]+src_addr+dst_addr+real_dst_addr+seq_num_recv+payload_array[v]+crc_retransmit)
                        ser.write(input)
