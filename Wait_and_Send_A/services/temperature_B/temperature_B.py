...
while 1:
    try:
        ...
        with open('/home/pi/Desktop/Wait_and_Send_A/services/temperature_B/packets_recv_frm_BtoA.csv','w') as f:
        ...
        if packet_type_recv == packet_type[2]:
            ...
            if ack_recv == '111':
                ...
                input2 = 'ACK'
                ser.write(input2)
                temperature = listen("Listen",0.05)
                ...
                try:
                    ...
                    with open('/home/pi/Desktop/Wait_and_Send_A/services/temperature_B/packets_sent_frm_AforB.csv','w') as f:
                                writer = csv.writer(f,delimiter='\t');
                    ...
                    input = str(packet_type[7]+src_addr+dst_addr+real_dst_addr+seq_num+payload+crc)
                    ser.write(input)
                    t.sleep(2)
            ...
            if seq_num_recv in seq_num_array:
                ...
                input = str(packet_type[7]+src_addr+dst_addr+real_dst_addr+seq_num_recv+payload_array[v]+crc_retransmit)
                ser.write(input)
                print input
                t.sleep(1)
