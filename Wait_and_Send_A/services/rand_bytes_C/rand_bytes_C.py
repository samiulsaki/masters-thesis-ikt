...
while 1:
	try:
		...
		with open('/home/pi/Desktop/Wait_and_Send_A/services/rand_bytes_C/packets_recv_frm_AlltoA.csv','w') as f:
		...
		if packet_type_recv == packet_type[2]:
			if dst_addr_recv == src_addr:
				...
				with open('/home/pi/Desktop/Wait_and_Send_A/services/rand_bytes_C/packets_sent_frm_AforC.csv','w') as f:
						writer = csv.writer(f,delimiter='\t');
